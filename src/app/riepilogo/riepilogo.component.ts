...
import SettingsLegacy = DataTables.SettingsLegacy;
...
export class RiepilogoComponent implements  AfterViewInit, OnDestroy, OnInit {
  ...
  cercainrange() {
    ...
    if(!this.showDateRange) {
        this.riepilogoservice.data1 = this.primadata;
        this.riepilogoservice.data2 = this.secondadata;
    }
    range.data1 = this.riepilogoservice.data1;
    range.data2 = this.riepilogoservice.data2;
    this.toastr.info("Inizio ricerca!" , "Ricerca");

...
@Component({
  selector: 'app-creapreventivoallservito',
  templateUrl: './creapreventivoallservito.component.html',
  styleUrls: ['./creapreventivoallservito.component.css']
})
export class CreapreventivoallservitoComponent implements AfterViewInit, OnDestroy, OnInit {

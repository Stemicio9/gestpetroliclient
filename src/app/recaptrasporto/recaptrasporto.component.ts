...
@Component({
  selector: 'app-recaptrasporto',
  templateUrl: './recaptrasporto.component.html',
  styleUrls: ['./recaptrasporto.component.css']
})
export class RecaptrasportoComponent implements  AfterViewInit, OnDestroy, OnInit {

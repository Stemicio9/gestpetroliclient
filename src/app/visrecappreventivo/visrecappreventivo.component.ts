...
@Component({
  selector: 'app-visrecappreventivo',
  templateUrl: './visrecappreventivo.component.html',
  styleUrls: ['./visrecappreventivo.component.css']
})
export class VisrecappreventivoComponent implements OnInit {
  ...
  tornaindietro() {
    ...
    this.router.navigate(['/admin/vispreventivo']);
  }
}
